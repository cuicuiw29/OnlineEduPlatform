package com.cuicui.pgd.service.vod.service.impl;
...
import com.cuicui.pgd.service.vod.util.AliyunVodSDKUtils;
import com.cuicui.pgd.service.vod.util.VodProperties;
...
public class VideoServiceImpl implements VideoService {
    ...
    public String uploadVideo(InputStream inputStream, String originalFilename) {
        ...
        if(StringUtils.isEmpty(videoId)){
            ...
            throw  new cuicuiwException(ResultCodeEnum.VIDEO_UPLOAD_ALIYUN_ERROR);
        }
