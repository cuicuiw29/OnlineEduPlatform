package com.cuicui.pgd.service.uct.controller.api;
...
public class ApiMemberController {
    ...
    public R getLoginInfo(HttpServletRequest request){
        try {
            ...
            log.info("响应请求 返回数据为"+memberIdByJwtToken);
                return R.ok().data("userInfo",memberIdByJwtToken);
        }catch (Exception e){
            log.error("解析用户信息失败："+e.getMessage());
            throw new cuicuiwException(ResultCodeEnum.FETCH_USERINFO_ERROR);
        }
    }
