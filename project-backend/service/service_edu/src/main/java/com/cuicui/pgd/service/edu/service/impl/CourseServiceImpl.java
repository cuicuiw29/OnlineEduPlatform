...
import com.cuicui.pgd.service.edu.entity.CourseDescription;
...
import com.cuicui.pgd.service.edu.mapper.*;
import com.cuicui.pgd.service.edu.entity.*;
...
//        更新CourseDescription
    ...
    public boolean publishCourseById(String id) {
        Course course = new Course();
        course.setId(id);
        course.setStatus(Course.COURSE_NORMAL);//设置为发布状态
