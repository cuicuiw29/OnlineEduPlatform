package com.cuicui.pgd.service.trd.controller.api;
...
public class ApiOrderController {
    ...
    public R save(@PathVariable String courseId, HttpServletRequest request){
        ...
        log.info("响应请求 请求为"+request.getHeader("token"));
        log.info("响应请求 请求为"+courseId);
        log.info("响应请求 返回数据为"+jwtInfo);
    ...
    @ApiOperation(value = "更改订单购买状态")
    @GetMapping("auth/update/{orderId}")
    public R updateOrderStatus(@PathVariable String orderId, HttpServletRequest request) {
        JwtInfo jwtInfo = JwtUtils.getMemberIdByJwtToken(request);
        log.info("响应请求 请求为"+request.getHeader("token"));
        log.info("响应请求 请求为"+orderId);
        log.info("响应请求 返回数据为"+jwtInfo);
        orderService.updateOrderStatus(orderId, jwtInfo.getId());
